...
from .models import Device_Data, Soil_Electric_Conductivity_Events, Soil_Relative_Permittivity_Events, Battery_Voltage_Events, Par_Events, Relative_Humidity_Events, soil_temperature_events
